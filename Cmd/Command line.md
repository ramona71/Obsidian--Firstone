- use windows git bash, it doesn't work on cmd
- short cut   -> windows+x+i`
- get all files `dir -s` or `tree -f`                don't do this lmao      (ctr+c to cancel the command)
...
(doesnt work)Unfortunately, if you are on Windows and using Git Bash, the `man` command is not included, however, you can just type the command that you want to know more about and then `--help` and you will get similar info:
...
- `dir`              -> to get info in a dir 

| Command                             | Description                                                                       |
| ----------------------------------- | --------------------------------------------------------------------------------- |
| pwd                                 | Lists the path to the working directory                                           |
| ls                                  | List directory contents                                                           |
| ls -a/ ls -Force                    | List contents including hidden files (Files that begin with a dot)                |
